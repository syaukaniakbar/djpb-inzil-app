...
const StatCard = ({
    ...
    <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-100 transition hover:shadow-md dark:bg-gray-900 dark:ring-gray-700">
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto max-w-7xl space-y-8 p-6">
                ...
                <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                    <StatCard title="Inventaris Aktif" value={stats.activeBorrowings} icon={PackageCheck} colorClass="bg-blue-500 text-blue-600" />
                    ...
                    <StatCard title="Total Inventaris" value={stats.totalInventories} icon={Box} colorClass="bg-orange-500 text-orange-600" />
                ...
                <div className="rounded-3xl bg-gray-50 p-6 dark:bg-gray-950/50">
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        <div className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-900">
                            <p className="mb-4 text-sm font-bold text-gray-400 uppercase tracking-widest dark:text-gray-300">Peminjaman Barang</p>
                        ...
                        <div className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-900">
                            <p className="mb-4 text-sm font-bold text-gray-400 uppercase tracking-widest dark:text-gray-300">Peminjaman Kendaraan</p>
                            <ul className="space-y-4">
                        ...
                        <div className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-900">
                            <p className="mb-4 text-sm font-bold text-gray-400 uppercase tracking-widest dark:text-gray-300">Peminjaman Ruangan</p>
                            <ul className="space-y-4">
                                ...
                                )) : <p className="text-xs text-gray-400 italic dark:text-gray-400/80">Tidak ada pemesanan ruangan</p>}
                            </ul>
                        </div>
                    </div>
                </div>
